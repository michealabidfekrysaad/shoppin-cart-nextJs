            ...
            {CartReducer.products.map((prod) => {
              return (
                <TableRow key={prod.id}>
                  <TableCell component="th" className={styles.prodCell} scope="row">
                    <img
                  ...
                  <TableCell className={styles.prodTitle}>{prod.title}</TableCell>
                  <TableCell>
                    {prod.qty} * {prod.price}
                  </TableCell>
                  <TableCell className={styles.prodTotal}>{prod.total}</TableCell>
                  <TableCell>
                    <Btn
                      size="small"
                      variant="contained"
